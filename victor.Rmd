...
all_data2 %>%
  ...
  with(
    {walk(prop_var_explained_plot, print); walk(first_pc_loadings_plot, print)}
  )
```
...
all_data2 %>%
  mutate(
    ...
    title = map_chr(
      ss_num,
      ~ str_interp(
        "PC1 Loadings for Staining Set ${.x}, AreaShape Variables Only"
      )
    ),
    first_pc_loadings_plot = map2(
      pca_results, title, make_first_pc_loadings_plot
...
all_data2 %>%
  mutate(
    ...
    title = map_chr(
      ss_num,
      ~ str_interp(
        "PC1 Loadings for Staining Set ${.x}, Intensity Variables Only"
      )
    ),
    first_pc_loadings_plot = map2(
      pca_results, title, make_first_pc_loadings_plot
...
all_data2 %>%
  mutate(
    ...
    title = map_chr(
      ss_num, ~ str_interp("PCA for Staining Set ${.x}, Cycle Variables Only")
    ),
    prop_var_explained_plot = map2(
      pca_results, title, make_prop_var_explained_plot
    ),
    title = map_chr(
      ss_num,
      ~ str_interp("PC1 Loadings for Staining Set ${.x}, Cycle Variables Only")
    ),
    first_pc_loadings_plot = map2(
      pca_results, title, make_first_pc_loadings_plot
    )
...
all_data2 %>%
  ...
  mutate(
    ...
    title = map_chr(
      ss_num, ~ str_interp("PCA for Staining Set ${.x}, Gated Variables Only")
    ),
    prop_var_explained_plot = map2(
      pca_results, title, make_prop_var_explained_plot
    ),
    title = map_chr(
      ss_num,
      ~ str_interp("PC1 Loadings for Staining Set ${.x}, Gated Variables Only")
    ),
    first_pc_loadings_plot = map2(
      pca_results, title, make_first_pc_loadings_plot
    )
...
all_data2 %>%
  ...
  mutate(
    ...
    title = map_chr(
      ss_num,
      ~ str_interp(
        "PC1 Loadings for Staining Set ${.x}, Texture Variables Only"
      )
    ),
    first_pc_loadings_plot = map2(
      pca_results, title, make_first_pc_loadings_plot
...
all_data2 %>%
  ...
  mutate(
    ...
    title = map_chr(
      ss_num, ~ str_interp("PCA for Staining Set ${.x}, Cells Variables Only")
    ),
    prop_var_explained_plot = map2(
      pca_results, title, make_prop_var_explained_plot
    ),
    title = map_chr(
      ss_num,
      ~ str_interp("PC1 Loadings for Staining Set ${.x}, Cells Variables Only")
    ),
    first_pc_loadings_plot = map2(
      pca_results, title, make_first_pc_loadings_plot
    )
...
all_data2 %>%
  ...
  mutate(
    ...
    title = map_chr(
      ss_num,
      ~ str_interp(
        "PC1 Loadings for Staining Set ${.x}, Cytoplasm Variables Only"
      )
    ),
    first_pc_loadings_plot = map2(
      pca_results, title, make_first_pc_loadings_plot
...
all_data2 %>%
  mutate(
    ...
    title = map_chr(
      ss_num, ~ str_interp("PCA for Staining Set ${.x}, Nuclei Variables Only")
    ),
    prop_var_explained_plot = map2(
      pca_results, title, make_prop_var_explained_plot
    ),
    title = map_chr(
      ss_num,
      ~ str_interp(
        "PC1 Loadings for Staining Set ${.x}, Nuclei Variables Only"
      )
    ),
    first_pc_loadings_plot = map2(
      pca_results, title, make_first_pc_loadings_plot
