...
We fit linear models; most of the form (stated in the parlance of R)
\begin{align*}
  \text{dependent\_var} \sim \text{Ligand1} + \text{ECM1} + \text{stain\_num} \tag{1}
\end{align*}
and a couple of the more complicated form
\begin{align*}
...
The intercept estimates the average value of the dependent variable measured for cells in staining set 1 (in the case where stain\_num is included; otherwise the sole staining set in which the variable was measured) treated with COL1 and FBS. Note that this treatment uses the control ECMp and control ligand, which makes it a natural baseline for comparison. 
